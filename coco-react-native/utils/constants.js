...
const styles = StyleSheet.create({
  ...
  backButtonText: {
    fontFamily: MAINFONT,
    fontSize: Math.round(20*FONT_SCALE),
...
export const allAssets = [require('../assets/dogs/dog1.png'), require('../assets/dogs/dog2.png'), require('../assets/dogs/dog3.png'), require('../assets/dogs/dog4.png'), require('../assets/dogs/dog5.png'), require('../assets/dogs/dog6.png'), require('../assets/dogs/dog7.png'), require('../assets/dogs/dog8.png'), require('../assets/dogs/dog9.png'), require('../assets/dogs/sad1.png'), require('../assets/dogs/sad2.png'), require('../assets/dogs/sad3.png'), require('../assets/dogs/sad4.png'), require('../assets/dogs/sad5.png'), require('../assets/dogs/sad6.png'), require('../assets/dogs/sad7.png'), require('../assets/dogs/sad8.png'), require('../assets/dogs/sad9.png'), require('../assets/dogs/side1.png'), require('../assets/dogs/side2.png'), require('../assets/dogs/side3.png'), require('../assets/dogs/side4.png'), require('../assets/dogs/side5.png'), require('../assets/dogs/side6.png'), require('../assets/dogs/side7.png'), require('../assets/dogs/side8.png'), require('../assets/dogs/side9.png'), require('../assets/dogs/sniff1.png'), require('../assets/dogs/sniff2.png'), require('../assets/dogs/sniff3.png'), require('../assets/dogs/sniff4.png'), require('../assets/dogs/sniff5.png'), require('../assets/dogs/sniff6.png'), require('../assets/dogs/sniff7.png'), require('../assets/dogs/sniff8.png'), require('../assets/dogs/sniff9.png'), require('../assets/dogs/wink1.png'), require('../assets/dogs/wink2.png'), require('../assets/dogs/wink3.png'), require('../assets/dogs/wink4.png'), require('../assets/dogs/wink5.png'), require('../assets/dogs/wink6.png'), require('../assets/dogs/wink7.png'), require('../assets/dogs/wink8.png'), require('../assets/dogs/wink9.png'), require('../assets/logo.png'), require('../assets/bone.png'), require('../assets/barcode1.png'), require('../assets/barcode2.png'), require('../assets/thoughtbubble2.png'), require('../assets/thoughtbubble3.png'), require('../assets/speech.png'), require('../assets/bone.png'), require('../assets/confetti.gif'), require('../assets/bone.png'), require('../assets/company-logos/amazon.png'), require('../assets/company-logos/amtrak.png'), require('../assets/company-logos/americaneagle.png'), require('../assets/company-logos/traderjoes.png'), require('../assets/company-logos/tates.png'),  require('../assets/company-logos/kerrygold.png'), require('../assets/company-logos/organicvalley.png'), require('../assets/company-logos/skinnypop.png'), require('../assets/company-logos/stellarosa.png'), ]

export const FONT_SCALE = Dimensions.get('window').width/440;